      ...
      <div className="w-full h-full overflow-hidden">
        <div className="w-full h-full overflow-y-scroll">
          <div className="w-full h-full flex flex-col items-center justify-center gap-10 p-5">
            ...
            <div className="animate-bounce">scroll to find hear my story</div>
          </div>
          <div className="w-full h-full flex flex-col items-center justify-center gap-10 text-2xl text-center p-5">
            ...
            <div>A Bay Area native, former San Diego beach bum, and enjoyer of good vibes.</div>
            <div>
          ...
          <div className="w-full h-full flex flex-col items-center justify-center gap-10 text-2xl text-center p-5">
            <div className="text-5xl self-start translate-x-20 pb-10">Outside of work you can find me.</div>
